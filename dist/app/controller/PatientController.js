...
var PatientController = (_dec = (0, _ApiDecorator.Api)({
  ...
  _createClass(PatientController, null, [{
    ...
    key: "getPatients",
    value: function () {
      var _getPatients = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(ctx) {
    ...
    key: "getFullPatients",
    value: function () {
      var _getFullPatients = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(ctx) {
    ...
    key: "exportPatients",
    value: function () {
      var _exportPatients = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(ctx) {
    ...
    key: "getPatientById",
    value: function () {
      var _getPatientById = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(ctx) {
        var id;
    ...
    key: "createPatient",
    value: function () {
      var _createPatient = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(ctx) {
    ...
    key: "updatePatient",
    value: function () {
      var _updatePatient = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(ctx) {
        var requestData, error;
    ...
    value: function () {
      var _createOrUpdatePatient = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(ctx) {
        var requestData, error;
    ...
    key: "enablePatient",
    value: function () {
      var _enablePatient = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(ctx) {
        var id;
    ...
    key: "disablePatient",
    value: function () {
      var _disablePatient = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(ctx) {
        var id;
...
}(), (_applyDecoratedDescriptor(_class2, "getPatients", [_dec2], Object.getOwnPropertyDescriptor(_class2, "getPatients"), _class2), _applyDecoratedDescriptor(_class2, "getFullPatients", [_dec3], Object.getOwnPropertyDescriptor(_class2, "getFullPatients"), _class2), _applyDecoratedDescriptor(_class2, "exportPatients", [_dec4], Object.getOwnPropertyDescriptor(_class2, "exportPatients"), _class2), _applyDecoratedDescriptor(_class2, "getPatientById", [_dec5], Object.getOwnPropertyDescriptor(_class2, "getPatientById"), _class2), _applyDecoratedDescriptor(_class2, "createPatient", [_dec6], Object.getOwnPropertyDescriptor(_class2, "createPatient"), _class2), _applyDecoratedDescriptor(_class2, "updatePatient", [_dec7], Object.getOwnPropertyDescriptor(_class2, "updatePatient"), _class2), _applyDecoratedDescriptor(_class2, "createOrUpdatePatient", [_dec8], Object.getOwnPropertyDescriptor(_class2, "createOrUpdatePatient"), _class2), _applyDecoratedDescriptor(_class2, "enablePatient", [_dec9], Object.getOwnPropertyDescriptor(_class2, "enablePatient"), _class2), _applyDecoratedDescriptor(_class2, "disablePatient", [_dec10], Object.getOwnPropertyDescriptor(_class2, "disablePatient"), _class2)), _class2)) || _class);
