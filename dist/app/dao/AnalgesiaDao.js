        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _AnalgesiaModel["default"].findAll({
              where: {
                patientId: _defineProperty({}, _sequelize["default"].Op.eq, patientId)
              },
              include: [{
                model: _SensoryBlockModel["default"],
                as: 'thoracicSensoryBlockLeft',
                where: {
                  type: _defineProperty({}, _sequelize["default"].Op.eq, 1)
                },
                required: false
              }, {
                model: _SensoryBlockModel["default"],
                ...
                where: {
                  type: _defineProperty({}, _sequelize["default"].Op.eq, 2)
                },
                required: false
              }, {
                model: _SensoryBlockModel["default"],
...
function _isAnalgesiaDataExist() {
  _isAnalgesiaDataExist = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(patientId, timePoint) {
        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _AnalgesiaModel["default"].count({
              where: {
                patientId: _defineProperty({}, _sequelize["default"].Op.eq, patientId),
                timePoint: _defineProperty({}, _sequelize["default"].Op.eq, timePoint)
              }
            });
          case 2:
...
function _createAnalgesiaData() {
  _createAnalgesiaData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(data) {
...
function _updateAnalgesiaData() {
  _updateAnalgesiaData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(data) {
        ...
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return _AnalgesiaModel["default"].update(data, {
              where: {
                patientId: _defineProperty({}, _sequelize["default"].Op.eq, data.patientId),
                timePoint: _defineProperty({}, _sequelize["default"].Op.eq, data.timePoint)
              }
            });
          case 2:
...
function _createOrUpdateAnalgesiaData() {
  _createOrUpdateAnalgesiaData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(data) {
