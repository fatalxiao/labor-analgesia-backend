...
function _createObservalData() {
  _createObservalData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(patientId, data) {
    var result;
...
function _updateObservalData() {
  _updateObservalData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(patientId, data) {
    var result;
...
function _createOrUpdateObservalData() {
  _createOrUpdateObservalData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(patientId, data) {
    var result;
